...
- One written number, the 1px edge, for the fifth time in the library. **Still no border-width scale**, and five components is now the strongest evidence one is owed.
