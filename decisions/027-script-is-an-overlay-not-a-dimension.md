...
- **`selftest` goes from 217 to 222 assertions**, on two new fixture roots: one proving an overlay does not multiply the matrix, one proving a colliding overlay is refused.
