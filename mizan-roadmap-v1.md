...
- **Also corrected here.** The 4-mode line above originally read Light/Dark × LTR/RTL — direction is not a mode dimension ([014](decisions/014-direction-is-not-a-mode-dimension.md)).
